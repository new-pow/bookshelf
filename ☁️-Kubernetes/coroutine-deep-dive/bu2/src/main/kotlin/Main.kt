/**
 * Bu2 코루틴 라이브러리 예시 실행기
 *
 * 각 예시를 실행하려면 다음 명령어를 사용하세요:
 * - Basic 예시: gradle run --args="basic"
 * - Advanced 예시: gradle run --args="advanced"
 */
...
fun main(args: Array<String>) {
    ...
    when(example) {
        ...
        "advanced" -> runAdvancedExample()
            ...
            println("사용 방법:")
            println("  ./gradlew run --args=\"basic\"     - 기본 코루틴 예시")
            println("  ./gradlew run --args=\"advanced\"  - Flow 고급 예시")
            println("\n기본값으로 basic 예시를 실행합니다.\n")
            runBasicExample()
        }
    }
}
